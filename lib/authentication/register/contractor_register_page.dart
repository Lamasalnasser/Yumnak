...
class ContractorRegisterPage extends StatefulWidget {
  final User? user;
  const ContractorRegisterPage({Key? key, this.user}) : super(key: key);
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  widget.user != null ? "Update": "Register/ Contractor",
                ...
                BlocBuilder<GenericCubit<bool>,
                    ...
                    builder: (context, state) {
                      return state.data
                        ...
                        onClick: (){
                          if (widget.user != null){
                            viewModel.contractorUpdateProfile(widget.user!.id!);
                          }else{
                            viewModel.contractorRegister();
                          }
                        }
                    );
                  }
