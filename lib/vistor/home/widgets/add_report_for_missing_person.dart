...
class AddReportForMissingPerson extends StatefulWidget {
  final VistorHomeViewModel viewModel;
  const AddReportForMissingPerson({Key? key, required this.viewModel}) : super(key: key);

  @override
  State<AddReportForMissingPerson> createState() => _AddReportForMissingPersonState();
}

class _AddReportForMissingPersonState extends State<AddReportForMissingPerson> {
  @override
        ...
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text("الإبلاغ عن شخص مفقود", style: AppStyles.kTextStyleHeader20,),
                AppSize.h40.ph,
                Container(
