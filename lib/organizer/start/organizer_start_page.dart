...
class OrganizerStartPage extends StatefulWidget {
  const OrganizerStartPage({Key? key}) : super(key: key);

  @override
  State<OrganizerStartPage> createState() => _OrganizerStartPageState();
}

class _OrganizerStartPageState extends State<OrganizerStartPage> {
